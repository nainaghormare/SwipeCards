...
public final class DropDown: UIView {
    ...
    fileprivate lazy var arrowIndication: UIImageView = {
        ...
        let color = UIColor(red: 68.0/255.0, green: 0.0/255.0, blue: 116.0/255.0, alpha: 1.0)//rgba(68, 0, 116, 1)
	...
	func setupUI() {
        ...
        for view in tableView.subviews {
            if view.isKind(of: UIImageView.self),
                ...
                imageView.image = nil
                view.backgroundColor = UIColor(red: 68.0/255.0, green: 0.0/255.0, blue: 116.0/255.0, alpha: 1.0)
            }
        }
