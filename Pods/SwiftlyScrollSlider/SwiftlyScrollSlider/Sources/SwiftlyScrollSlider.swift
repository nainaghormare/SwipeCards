...
open class SwiftlyScrollSlider: UIView {
    ...
    open var lineBackgroundWidth: CGFloat = 0.1//0.5
    ...
    func setupView() {
        thumbImageView = UIImageView(image: #imageLiteral(resourceName: "scrollView"))
        thumbImageView?.tintColor = UIColor(red: 68.0/255.0, green: 0.0/255.0, blue: 116.0/255.0, alpha: 1.0)
        thumbImageView?.contentMode = .center
        
        lineBackgroundView = UIView(frame: CGRect(x: 0, y: 0, width: thumbImageView!.image!.size.width, height: self.bounds.size.height))
        ...
        lineBackgroundView?.backgroundColor = UIColor.lightGray
